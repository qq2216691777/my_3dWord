...
(function (document, window) {
    ...
    document.addEventListener("impress:init", function (event) {
        ...
        function refreshCount() {
            ...
            if (window.location.href.indexOf("tiny") != -1) {
                api.next();
                t1 = window.setInterval(refreshCount, 4000);
            } else if (window.location.href.indexOf("ing") != -1) {
                api.next();
               
                t1 = window.setInterval(refreshCount, 2000);
            } else if (window.location.href.indexOf("its") != -1) {
                api.next();

                t1 = window.setInterval(refreshCount, 2500);
